...
export const WandIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c.251.042.502.092.752.152v5.456c.354-.06.71-.114 1.068-.162m-1.82 5.592a2.25 2.25 0 01-1.591.659H5.25m11.563-1.542a2.25 2.25 0 00-1.591-.659h-1.682a2.25 2.25 0 01-1.591-.659l-3.681-3.682a2.25 2.25 0 00-1.591-.659H6.25m10.5 4.5a.75.75 0 00.75-.75V8.25a.75.75 0 00-.75-.75h-2.25a.75.75 0 00-.75.75v2.25c0 .414.336.75.75.75h2.25m-6.75-4.5a.75.75 0 00-.75.75v2.25c0 .414.336.75.75.75h2.25a.75.75 0 00.75-.75V8.25a.75.75 0 00-.75-.75h-2.25M15 3.75a.75.75 0 00-.75.75v2.25a.75.75 0 00.75.75h2.25a.75.75 0 00.75-.75V4.5a.75.75 0 00-.75-.75h-2.25Z" />
    </svg>
);
...
export const LinkedInIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M20.5 2h-17A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h17a1.5 1.5 0 001.5-1.5v-17A1.5 1.5 0 0020.5 2zM8 19H5v-9h3zM6.5 8.25A1.75 1.75 0 118.25 6.5 1.75 1.75 0 016.5 8.25zM19 19h-3v-4.75c0-1.12-.02-2.55-1.5-2.55-1.5 0-1.73 1.18-1.73 2.47V19h-3v-9h2.88v1.32h.04c.4-.76 1.37-1.55 2.82-1.55 3.01 0 3.56 1.98 3.56 4.56V19z" />
    </svg>
);
